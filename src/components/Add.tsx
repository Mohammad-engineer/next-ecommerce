  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex justify-between">
        ...
        <button className="w-36 text-sm rounded-3xl ring-1 ring-pinky text-pinky py-2 px-4 hover:bg-pinky hover:text-white disabled:cursor-not-allowed disabled:bg-pink-200 disabled:text-white disabled:ring-none">
          Add to Cart
        </button>
      </div>
    </div>
